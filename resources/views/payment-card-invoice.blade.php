    ...
    <div class="container custom-container-lg my-3">
        ...
        <form action="{{ url()->current() . '?' . http_build_query(request()->query()) }}" method="POST">
            ...
            <div class="card card-body shadow">
                ...
                <div class="row align-items-center mb-3">
                    <label for="card-number" class="col-sm-4 col-form-label">Card Number <span class="text-danger">*</span></label>
                    <div class="col-sm-8">
                        <input type="text" class="form-control @error('card_number') is-invalid @enderror" name="card_number" placeholder="Card Number" id="card-number" required value="{{ old('card_number') }}">
                        @error('card_number')
                            <span class="text-danger">{{$message}}</span>
                        @enderror
                    </div>
                ...
                <div class="row align-items-center mb-3">
                    <label for="expiry-month" class="col-sm-4 col-form-label">Card Expiry Month <span class="text-danger">*</span></label>
                    <div class="col-sm-8">
                        <input type="text" class="form-control @error('expiry_month') is-invalid @enderror" name="expiry_month" placeholder="Card Expiry Month" id="expiry-month" required value="{{ old('expiry_month') }}">
                        @error('expiry_month')
                            <span class="text-danger">{{$message}}</span>
                        @enderror
                    </div>
                ...
                <div class="row align-items-center mb-3">
                    <label for="expiry-year" class="col-sm-4 col-form-label">Card Expiry Year <span class="text-danger">*</span></label>
                    <div class="col-sm-8">
                        <input type="text" class="form-control @error('expiry_year') is-invalid @enderror" name="expiry_year" placeholder="Card Expiry Year" id="expiry-year" required value="{{ old('expiry_year') }}">
                        @error('expiry_year')
                            <span class="text-danger">{{$message}}</span>
                        @enderror
                    </div>
                ...
                <div class="row align-items-center mb-3">
                    <label for="cvv" class="col-sm-4 col-form-label">Card CVV <span class="text-danger">*</span></label>
                    <div class="col-sm-8">
                        <input type="text" class="form-control @error('cvv') is-invalid @enderror" name="cvv" placeholder="Card CVV" id="cvv" required value="{{ old('cvv') }}">
                        @error('cvv')
                            <span class="text-danger">{{$message}}</span>
                        @enderror
                    </div>
